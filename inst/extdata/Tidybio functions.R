...
healthcare <- function(YourFolder, YourRdsFile, DataframeName, DataframeTitle, DataframeSource, DataframeDescription, DataframeAbout, JoinFileName, JoinName, JoinAbout, JoinVariable, JoinedName){
  documentNew(
    paste0("###healthcare dataset\nlibrary(here)\nlibrary(readr)\nlibrary(dplyr)\n#set these variables",
           ...
           "\npath_to_data <- here::here('tutorials/", YourFolder,"/data', " , YourRdsFile , ")",
           ...
           "\nheart_joined <- read_csv(here::here('tutorials/", YourFolder,"/data', " , JoinFileName , ")) %>%  right_join(heart, by = ", "'",JoinVariable, "')",
           "\n#joined",
...
# Example
healthcare(YourFolder = "lecture10_intro_to_select",
           YourRdsFile = "heart.Rds",
           DataframeName = "heart",
           DataframeTitle = "Heart Disease Dataset",
           ...
           DataframeAbout = "patients",
           JoinFileName = "phx.csv",
           JoinName = "patient_hx",
...
bespoke <- function(df, YourFolder){
  documentNew(
    paste0("set.seed(42)\nlibrary(tidyverse)\n#load dataset for for class",
           "\nsource(here::here('tutorials/", YourFolder,"/code', "  ,"'",df,"'","))", "#loads dataset-specific variables",
           "\n#make dataframes",
...
# Example
bespoke("healthcare.R", YourFolder = "lecture10_intro_to_select")
